...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li class="active">Verzoeken aan secretariaat</li>
    </ol>

    <h2>Verzoeken aan secretariaat</h2>
        ...
        <div class="panel panel-default discussiontable">
            <table class="table table-hover" >
                ...
                <tr>
                    ...
                    <td><a href="index.php?p=verzoek_reactie"><span class="glyphicon glyphicon-align-justify"></span></a></td>

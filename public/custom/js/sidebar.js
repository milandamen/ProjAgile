...
function addSideRow(button){
	...
	var row = table.insertRow();
 	...
 	cellIntern.innerHTML = 'Intern <input id="page_name" name="sidebar['+ tableNumber+'][pagename][]" type="text" list="pagedata" /><datalist id="pagedata"> @foreach($menu as $menuitem)<option value="{{$menuitem->relativeUrl}}" label="{{$menuitem->name}}"> @endforeach </datalist>';
